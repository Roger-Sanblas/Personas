...
public class Main {
	private static char menu(Scanner sc) {
		...
		System.out.println("B: AÃ±adir profesor");
		System.out.println("C: AÃ±adir Alumno");
		System.out.println("D: Quitar persona");
		System.out.println("E: Persona Cumple Aï¿½os");
		...
		System.out.println("Ã±: Promedio de edades de todos las personas");
